...
describe PayRatesController do
  ...
  it "creates pay_rate" do
    expect {
      post pay_rates_url, params: {pay_rate: {holiday: pay_rate.holiday, projects: pay_rate.projects, rate: pay_rate.rate, superannuation: pay_rate.superannuation, user: pay_rate.users}}
  ...
  it "updates pay_rate" do
    patch pay_rate_url(pay_rate), params: {pay_rate: {holiday: pay_rate.holiday, projects: pay_rate.projects, rate: pay_rate.rate, superannuation: pay_rate.superannuation, user: pay_rate.users}}
